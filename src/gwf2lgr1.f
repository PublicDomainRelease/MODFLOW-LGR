      MODULE LGRMODULE
         ...
         INTEGER, SAVE, POINTER ::NPREND,NPCEND,NCPP,NPL,NPLAY,IBOTFLG
        ...
        TYPE LGRTYPE
         ...
         INTEGER, POINTER ::NPREND,NPCEND,NCPP,NPL,NPLAY,IBOTFLG
...
C     ------------------------------------------------------------------
     ...
     1                      NPCEND,NCPP,NPL,NPLAY,IBOTFLG,ISHFLG,IBFLG,
...
C     ------------------------------------------------------------------
     ...
     1         NPL,NPLAY,IBOTFLG,ISHFLG,IBFLG,IUPBHSV,IUCBHSV,IUPBFSV,
...
C4D2----NPLAY IS HARDWIRED TO TOP PARENT. IT SHOULD BE INDEXED TO 
C4D2----CURRENT PARENT FOR THIS GRID.
        LGRDAT(1)%NPLAY=NLAY
        IBOTFLG = 1
        IF(NPLBEG .EQ. NPLEND .OR.
     &     NPLEND .EQ. LGRDAT(1)%NPLAY) IBOTFLG=0
        NSUM = 0
        IF(NPL .GT. 1)THEN
          DO K=1,NPL
            NSUM = NSUM + NCPPL(K) 
