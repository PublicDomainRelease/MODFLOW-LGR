...
C     ------------------------------------------------------------------
     ...
     1                      ISFAC,ICONCV,ITHFLG,NOCVCO,WETFCT,HDRY,
...
C     ------------------------------------------------------------------
     ...
     1                      LBOTM,CC,STRT
      USE GWFLPFMODULE,ONLY:LAYWET,IWETIT,LAYTYP,HDRY,LAYAVG,LAYSTRT
C
      CHARACTER*3 ACNVRT
...
C
        ...
        DEALLOCATE(GWFLPFDAT(IGRID)%HDRY)
